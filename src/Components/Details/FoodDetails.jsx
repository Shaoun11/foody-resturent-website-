...
const FoodDetails = () => {
  ...
  <div  className=" lg:ml-12 lg:mr-12 md:ml-12 md:mr-12 py-24 mx-auto">
    <div  className="lg:w-[100%]  mx-auto flex flex-wrap">
      <img alt="ecommerce"  className="lg:w-1/2 md:w-[600px] md:h-[600px] sm:w-[800px] mt-8 object-cover object-center rounded border border-gray-200" src={foodImage}/>
      <div  className="lg:w-1/2 w-full lg:pl-10 md:pl-10 pl-3 pr-3 lg:py-6 mt-6 lg:mt-0">
        ...
        <div  className="flex justify-between">
         <div>
         <span  className="title-font flex  font-medium text-2xl text-gray-900">${price}</span>
