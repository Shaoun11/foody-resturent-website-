...
const Contact = () => {
    return (
		...
		<div className="flex flex-col justify-between">
			...
			<img  src="https://i.ibb.co/ZmPWjq1/depositphotos-140411210-stock-illustration-cartoon-cute-funny-chef-cook.webp" alt="Contact our customer support" className=" lg:-ml-32 -ml-5 w-[1700px]" />
		</div>
		<form novalidate="" className="space-y-6 mt-16 ">
			<div>
